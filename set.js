...
module.exports = { session: process.env.SESSION_ID || 'SIMEO',
    PREFIXE: process.env.PREFIX || ".",
    GITHUB : process.env.GITHUB|| 'https://github.com/CORAZON-MD/CORAZON-MD,
    OWNER_NAME : process.env.OWNER_NAME || "CORAZON",
    NUMERO_OWNER : process.env.NUMERO_OWNER || "255683520005",  
    ...
    URL: process.env.URL || "https://files.catbox.moe/4231aa.jpg",  
   ...
   GREET_MSG: process.env.GREET_MSG || "𝐶𝑜𝑟𝑎𝑧𝑜𝑛 am unavailable 😂",               
    ...
    AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || 'viewed by 𝐶𝑜𝑟𝑎𝑧𝑜𝑛',   
    ...
    BOT : process.env.BOT_NAME || '𝐶𝑂𝑅𝐴𝑍𝑂𝑁-𝑀𝐷',
